...
*   **URL Tabanlı (SEO Önerilen):** Her dil ayrı URL'de (`/yerel/`, `/en/`, `/fr/`)
*   **Subdomain Tabanlı:** Dil bazlı subdomain'ler (`yerel.site.com`, `en.site.com`)
*   **Query Parameter Tabanlı:** Tek dosya yönetimi (`?lang=yerel`)
